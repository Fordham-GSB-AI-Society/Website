      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {hasEvents ? (
          <div className={gridOrFlexClass}>
            {events.map((event, index) => (
              <motion.div
                ...
                className={events.length === 1 ? "w-full max-w-md" : ""}
              >
          ...
          <motion.div
            ...
            className="text-center py-12 bg-muted/20 rounded-2xl border-2 border-dashed border-muted-foreground/20"
          >
            <h3 className="text-2xl font-semibold mb-2">More Events Coming Soon!</h3>
            <p className="text-muted-foreground">We're currently planning our next set of workshops and speaker sessions. Stay tuned!</p>
          </motion.div>
        )}
      </div>
    </section>
